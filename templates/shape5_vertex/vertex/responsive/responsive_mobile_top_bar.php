...
<div id="s5_responsive_mobile_top_bar_wrap" style="margin-top:-50000px;position:absolute;z-index:20;top:0px">
	...
	<div id="s5_responsive_mobile_top_bar" class="s5_responsive_mobile_bar_<?php echo $s5_responsive_mobile_bar_style; ?>">
			...
			<div id="s5_responsive_mobile_toggle_click_logout" style="<?php if ($s5_responsive_mobile_bar_login == "enabled") { ?>display:block;<?php } else { ?>display:none;<?php } ?>float:right">
				<span></span>
			</div>
