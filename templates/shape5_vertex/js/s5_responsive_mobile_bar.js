...
$('#s5_responsive_mobile_toggle_click_login').bind('click', function(event){
	...
	//window.location.href='https://servidor-pruebas.us.es/eidus/plugins/authentication/lpsaml/simplesamlphp/www/module.php/core/authenticate.php?as=default-sp';
	//window.location.href='https://ssopre.us.es/SAML2/SSOService.php';
	...
	var scLogoutButton = document.getElementById('scLogoutButton');
	if (scLogoutButton === null){ 
		//alert('does not exist!');
		
		document.getElementById("form-sclogin-submitcreate-id").click();		
	}else{
		$( "#s5_responsive_mobile_toggle_click_login > span" ).addClass( "conectado" );
		document.getElementById("idscLogoutButton").click();	
	}
	
	

});
if (document.getElementById('scLogoutButton') === null){ 
	$( "#s5_responsive_mobile_toggle_click_login > span" ).addClass( "conectado" );
}else{
	$( "#s5_responsive_mobile_toggle_click_login > span" ).addClass( "desconectado" );
}
