...
$lpsaml_base = "https://servidor-pruebas.us.es/eidus/plugins/authentication/lpsaml/simplesamlphp/www/";
...
$config = array(
     ...
     */
    'technicalcontact_name' => 'Ezequiel Ardila',
    'technicalcontact_email' => 'ezequiel@us.es',
     ...
     */
    'session.cookie.domain' => '.servidor-pruebas.us.es',
    ...
    'authproc.idp' => array(
        ...
        */
        ...
        /* When called without parameters, it will fallback to filter attributes \8Bthe old way\9B
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'mysql:dbname=eidus;host=127.0.0.1',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'root',
    'store.sql.password' => 'doctorado2016',
