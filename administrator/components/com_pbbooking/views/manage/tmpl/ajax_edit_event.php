...
<div class="row-fluid">
	...
	<div class="span12">
			...
			<div class="row-fluid">
				...
				<div class="span2"><a href="index.php?option=com_pbbooking&view=event&id=<?php echo $this->event->id;?>&tmpl=component" id="edit-event" class="btn btn-primary" target="_blank"><?php echo JText::_("COM_PBBOOKING_PRINT_EVENT");?></a></div>
			</div>
