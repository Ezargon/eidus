        ...
        <div class="span9">
            ...
            <fieldset>
                ...
                <table class="admin-table table-striped" style="width:100%;">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5" align="right"><button class="btn btn-primary" data-bind="click: addQuestion" id="btnSurveyAddQuestion"><?php echo JText::_('COM_PBBOOKING_TESTIMONAIL_ADD_QUESTION');?></button></td>
                        </tr>
                    </tfoot>
                </table>
            </fieldset>
