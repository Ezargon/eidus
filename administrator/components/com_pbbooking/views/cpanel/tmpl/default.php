...
<form action="<?php echo JRoute::_('index.php?option=com_content&view=articles'); ?>" method="post" name="adminForm"
    ...
    <div class="row-fluid">
        <div class="span12 cpanel">
            ...
            <div class="icon">
                <a href="?option=com_pbbooking&view=emails">
                    <div class="fa fa-envelope fa-5x"></div>
                    <div><?php echo JText::_('COM_PBBOOKING_EMAILS'); ?></div>
                </a>
            </div>
            <div class="icon">
                <a href="?option=com_pbbooking&view=smss" id="btnSmsMessage">
                    <div class="fa fa-phone fa-5x"></div>
                    <div><?php echo JText::_('COM_PBBOOKING_SMSS'); ?></div>
                    <span
                        class="pro <?php echo (PBBOOKING_VERSION == 'free') ? 'locked' : null; ?>"><?php echo JText::_("COM_PBBOOKING_SUBSCRIBER_ONLY_ICON"); ?></span>
    ...
    <div class="row-fluid">
        ...
        <div class="span<?php echo ($this->config->disable_pending_bookings == 1) ? '12' : '6'; ?>">
            <div class="well well-small">
                <div
                    class="module-title nav-header"><?php echo JText::_('COM_PBBOOKING_DASHBOARD_UPCOMING_BOOKINGS'); ?></div>
                <div class="row-striped">
                    <?php if (count($this->upcoming_events) > 0) : ?>
                        <?php foreach ($this->upcoming_events as $event) : ?>
                            ...
                            <div class="row-fluid">
                                <div class="span9"><strong class="row-title"><a
                                            href="<?php echo JURI::root(false); ?>administrator/index.php?option=com_pbbooking&task=manage.display&dateparam=<?php echo $ev_obj->dtstart->format('Y-m-d'); ?>"><?php echo htmlspecialchars($ev_obj->getSummary()); ?></a></strong>
                                </div>
                                <div class="span3"><i
                                        class="icon-calendar"></i>&nbsp;<?php echo JHtml::_('date', $ev_obj->dtstart->format(DATE_ATOM), JText::_('COM_PBBOOKING_DASHBOARD_DTFORMAT')); ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <div class="row-fluid">
                            <div class="span12"><strong
                                    class="row-title"><?php echo JText::_('COM_PBBOOKING_DASHBOARD_NOTHING_FOUND'); ?></strong>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <?php if ($this->config->disable_pending_bookings != 1) : ?>
            ...
            <div class="span6">
                <div class="well well-small">
                    <div
                        class="module-title nav-header"><?php echo JText::_('COM_PBBOOKING_DASHBOARD_LATEST_PENDING_BOOKINGS'); ?></div>
                    <div class="row-striped">
                        <?php foreach ($this->pending_events as $event): ?>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span4">
                                    <a href="<?php echo JRoute::_('index.php?option=com_pbbooking&task=event.confirmdelete&id=' . $event->id . '&format=raw'); ?>"
                                       class="fa fa-trash-o modal"></a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <div class="row-fluid">
        <div class="span6">
            <div class="well well-small">
                <div
                    class="module-title nav-header"><?php echo JText::_('COM_PBBOOKING_DASHBOARD_CALENDAR_UTILIZATION_CURRENT_WEEK'); ?></div>
                ...
                <div class="row-striped">
                    <?php foreach ($this->cals as $cal) : ?>
                        <div class="row-fluid">
                            ...
                            <div
                                class="span3"><?php echo sprintf('%0.2f', $cal->get_calendar_utilization($this->dtstart, $this->dtend)); ?>
                                %
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        <div class="span6">
            <div class="well well-small">
                <div
                    class="module-title nav-header"><?php echo JText::_('COM_PBBOOKING_DASHBOARD_LATEST_SYNCS'); ?></div>
                <div class="row-striped">
    ...
    <div class="row-fluid">
        <div class="span12 cpanel">
            <div class="well well-small">
                ...
                <div class="icon">
                    <a href="?option=com_pbbooking&task=tools.restoreemail">
                        <div class="fa fa-envelope fa-5x"></div>
                        <div><?php echo JText::_('COM_PBBOOKING_DASHBOARD_RESTORE_EMAILS'); ?></div>
                    </a>
                </div>
    ...
    <?php if ($this->announcements): ?>
        <div class="row-fluid">
            <div class="span12 cpanel">
                <div class="well well-small">
                    <div
                        class="module-title nav-header"><?php echo JText::_('COM_PBBOOKING_DASHBOARD_ANNOUNCEMENTS'); ?></div>
                    <div class="row-fluid">
                        <?php //echo var_dump($this->announcements);?>
                        <?php for ($i = 0; $i < 5; $i++): ?>
                            <?php if ($this->announcements->offsetExists($i)) : ?>
                                <?php echo $this->announcements[$i]->content; ?>
                                <div
                                    class="text-muted"><?php echo $this->announcements[$i]->publishedDate->format(JText::_("DATE_FORMAT_LC")); ?></div>
                            <?php endif; ?>
                        <?php endfor; ?>
                    </div>
                </div>
