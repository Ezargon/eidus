...
/*
 *
 * @Version       $Id: script.php 2058 2015-08-17 08:09:27Z geoffc $
 ...
 * @Lastrevision  $Date: 2015-08-17 09:09:27 +0100 (Mon, 17 Aug 2015) $
 *
 */
...
class com_issuetrackerInstallerScript
{
    ...
    */
   private $release  = '1.6.9';     // Main release version
//   private $prelease = '1.6.9';     // Plugin release version
...
//      if ( $this->release == '1.2.0') $this->update_people();
   ...
   function getParam( $name ) {
      $db = JFactory::getDbo();
      $db->setQuery('SELECT manifest_cache FROM #__extensions WHERE element = "com_issuetracker"');
