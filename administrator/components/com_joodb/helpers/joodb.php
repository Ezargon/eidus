...
class JoodbAdminHelper
{
	...
	public static function getFunctions($context) {
		$functions = array (
		"catalog" => array('loop','pagenav','pagecount','resultcount','nodata','limitbox','searchbox|[fieldlist]','searchfield|FIELD|[cond]','alphabox','checkbox','groupselect|FIELD|[size]','sortlink|FIELD','readon','notepadbutton','exportbutton','searchbutton','resetbutton','backbutton','editbutton|[cond]','deletebutton'),
	...
	public static function printTemplateFooter($editorid,$fieldlist,$context) {
		echo "<table class='paramlist admintable' style='width: 100%;'><tr><td style='text-align: right'>".JText::_( 'Insert field' )."</td><td class='paramlist_value'>";
		...
		echo '</select>';
		echo "</td><td style='text-align: right'>".JText::_( 'Insert function' )."</td><td class='paramlist_value'>";
		...
		echo '</select>';
		echo ' <a href="https://joodb.feenders.de/support/documentation.html" target="_blank">'.JText::_ ('Help').'</a>';
		echo '</td></tr></table>';
	}
