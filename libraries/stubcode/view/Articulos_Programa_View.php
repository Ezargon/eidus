...
class Articulos_Programa_View {
    ...
    private function printEnlacePDF(){
        ...
        $print_ .= "<p>Descargar la siguiente ficha para m&aacute;s informaci�n sobre perfil de ingreso, requisitos y criterios de admisi�n, documentaci�n espec�fica y complementos de formaci�n: <span><a href=\"".HREF_IMPRESO_ADMISION.$uxxi.".pdf\" target='_blank' class='pdf'>Descargar</a></span></p>";
        $print_ .= "<br/>";
        return $print_;
    }
