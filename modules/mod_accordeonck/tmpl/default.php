			...
			default:
				switch ($item->browserNav) :
						...
						case 2:
							...
							echo $imageevent; ?><a class="<?php echo $class ?>" <?php echo $item->rel; ?>href="<?php echo $item->flink; ?>" onclick="window.open(this.href,'targetWindow','<?php echo $attribs;?>');return false;" <?php echo $title.$style; ?>><?php echo $linktype; ?></a><?php
							break;
					endswitch;	
				break;
		endswitch;
